...
export class FilesService {
     ...
     * @param data The data for the request.
     * @param data.fileId
     * @returns SourceTable Successful Response
     * @throws ApiError
     */
    public static readSourceTable(data: FilesReadSourceTableData): CancelablePromise<FilesReadSourceTableResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/files/{file_id}/table',
            path: {
                file_id: data.fileId
            },
            errors: {
