...
> Permite contrastar lo propuesto, lo previsto y lo medido, incluidos resultados parciales
> o fallidos. Revisión de fuentes: [17/09/2026](revision-2026-09-17.md).
>
...
**Rectificación 17/09/2026:** esos XLS sí contienen previsiones en `DR(100%)`, además de
identificar el muestreo origen. El siguiente muestreo disponible aporta evidencia posterior,
no prueba por sí solo la ejecución de cada acción. Ver [5-retoques-molde.md](5-retoques-molde.md#1-inventario-completo).
...
Varias diapositivas llevan `OK`; conservar el marcador sin equipararlo a ejecución probada
o conformidad dimensional de la pieza.
...
## 4. Bolt Eye (N170): mejora parcial, no resolución completa

Cavidad 13, cota **N170 Ø4 −0,1**, evaluación **GX** del CSV de CMM (bolt 1, altura H = 1,5 mm).
Las fechas de la tabla son las de emisión de los informes XLS:
...
**GX aumenta 0,545 mm entre `.01` y `.03` y se mantiene dentro**, pero solo es una evaluación.
N170 desaparece de la corrección 2 sin que ello demuestre conformidad. **Rectificación del
17/09/2026:** LP máximo para el mismo B1/H1,5/c13 es 3,477 → 4,018 → 4,023 → 4,023.
Los tres últimos superan 4,000. Los LP máximos fuera son 30/32 en `.03`, 28/32 en `.05`
y 26/32 en `.08`, frente a 0/32 GX fuera (cuatro cavidades × cuatro agujeros × dos alturas).
La previsión del Excel de corrección 1 era 3,929 / 3,977 para ese elemento.
Ver [fuentes y desglose](revision-2026-09-17.md).
...
## 5. Qué cambió entre los dos planes de corrección

Cotas que estaban en la corrección 1 y **desaparecen** en la 2 (no demuestra que quedaran OK):
...
> prueba. N170 es un contraejemplo: GX entra, muchos LP máximos siguen fuera. Verificar todas
> las evaluaciones exigidas y la aceptación, cota a cota.
...
### Comparación entre previsión y resultado de la corrección nº2

El cambio observado permite contrastar las previsiones, pero no acredita por sí solo la
ejecución ni la conformidad. Cavidad 13, XLS `DR(100%)` y CSV `.03` / `.05`:

| Evaluación | Previsión final | Medido `.05` | Medido − previsto | Resultado posterior |
|---|--:|--:|--:|---|
| N161 GX | 45,426 | 45,396 | −0,030 | Por debajo de 45,400 |
| N161 LP máximo | 45,505 | 45,531 | +0,026 | Por encima de 45,520 |
| N165 GLOBAL mínimo | 1,319 | 1,333 | +0,014 | Dentro |
| N165 GLOBAL máximo | 1,367 | 1,401 | +0,034 | Fuera; la previsión ya superaba 1,350 |
| N240 | 18,635 | 18,638 | +0,003 | Dentro |

N240 combina +0,020 del plano A y −0,080 local: −0,060 netos, frente a −0,057 observados.
La correspondencia con 2.13 se apoya en la imagen y las filas 224–225 del Excel,
no solo en la similitud del cambio. N165 combina +0,020 y −0,220; su GLOBAL resume
las medidas locales y es distinto de `N165 MIN/MAX`. [Celdas y fórmulas](revision-2026-09-17.md).
...
> y este mismo fichero por partida doble). Priorizar CSV para esas medidas CMM, conservando los XLS como fuente de contexto,
> otros ensayos y previsiones de corrección.
...
| N266 | Ø67,1 +0,1 según CSV/XLS | 67,126 | 67,120 | 67,121 | 67,130 | Dentro según CSV; título PPTX discrepante |
| N170 GX (bolt 1, H1,5) | Ø4 −0,1 | 3,978 | 3,975 | 3,976 | 3,974 | GX dentro; revisar LP máximo |

**N266 contrastada el 17/09/2026:** CSV y tablas XLS usan `+0,1`; los títulos de las slides
1.24 y 2.8 dicen `−0,1`. Conservar ambas fuentes y confirmar la especificación con rev.06.
El veredicto anterior se refiere a los límites del CSV.
